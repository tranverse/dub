  ...
  return (
    <Html>
      ...
      <Preview>
        ...
        create your Buzz Partner account to complete your application.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            <Section className="mb-8 mt-6">
              <Img src={DUB_WORDMARK} width="65" height="32" alt="Buzz" />
            </Section>
            ...
            <Text className="text-sm leading-6 text-neutral-600">
              ...
              saved, but you still need to create your Buzz Partners account
            ...
            <Section className="mt-8 text-center">
              ...
              >
                Create your Buzz Partners account
              </Link>
            </Section>
