...
export const NEXT_PUBLIC_DEFAULT_DOMAIN =
  process.env.NEXT_PUBLIC_DEFAULT_DOMAIN || "buzz.local.com";

export const NEXT_PUBLIC_DEFAULT_DOMAIN_PLACEHOLDER =
  process.env.NEXT_PUBLIC_DEFAULT_DOMAIN_PLACEHOLDER || "";
